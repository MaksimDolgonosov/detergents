    ...
    return (
        <main className="main">
            ...
            <div className='main__descr'>
                <p>{isAuth ? `${name}, добро` : `Добро`} пожаловать в интернет-магазин бытовой химии. Здесь вы можете найти интересующие вас <Link to="/goods">товары</Link> и мы доставим их в любую точку Республики Беларусь. Подробнее о доставке вы можете прочитать в <Link to="/delivery">соответствующем разделе</Link>. </p>
